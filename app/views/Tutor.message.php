<?php $data['title'] = 'Tutor Dashboard'; $this->view('inc/header',$data) ?>
    <link rel="stylesheet" href="<?php echo URLROOT;?>/assets/css/messages.css">

<body>
    <div class="container">
        <!-- start of sidebar -->
        <?php $this->view('inc/tutor.sidebar',$data) ?>
        <!-- end of sidebar -->
  ...
  <div class="mcontainer">
      ...
      <section class="discussions">
        ...
        <div class="chat_types">
          <a class="active" href="#home">Private</a>
  <a href="#news">Public</a>
 
  <a href="#about">Circles</a>
        </div>
      ...
      <section class="chat">
        <div class="header-chat">
          ...
          <p class="name">Madasha Liyanage</p>
