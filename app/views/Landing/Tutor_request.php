	...
	<div id="page-wrapper">
		...
		<section id="banner">
			<section  class="container">
				<section class="box special" style="color:black; background-color: rgba(255, 255, 255, 0.815);">
				...
				<form method="post" action="<?php echo URLROOT ?>/Landing/make_a_tutor_request" enctype="multipart/form-data">
					<div class="row gtr-50 gtr-uniform">
						<div class="col-6 col-12-mobilep">
							...
							?>
							<input type="text" name="fname" id="name" value="<?php if (isset($data['fname'])) {
																					echo $data['fname'];
						...
						<div class="col-6 col-12-mobilep">
							...
							?>
							<input type="text" name="lname" id="name" value="<?php if (isset($data['lname'])) {
																					echo $data['lname'];
						...
						<div class="col-6 col-12-mobilep">
							...
							?>
							<input type="text" name="cno" id="cno" value="<?php if (isset($data['cno'])) {
																				echo $data['cno'];
						...
						<div class="col-6 col-12-mobilep">
							...
							?>
							<input type="text" name="username" id="username" value="<?php if (isset($data['username'])) {
																						echo $data['username'];
						...
						<div class="col-12">
							...
							?>
							<input type="email" name="email" id="email" value="<?php if (isset($data['email'])) {
																					echo $data['email'];
