      ...
      <section class="section hero has-bg-image" id="home" aria-label="home"
        ...
        <div class="container">
          ...
          <div class="hero-content">
            ...
            A  <span class="span">Personalized</span> Learning Hub
            </h1>

            <p class="hero-text">
            IQube is a platform for your academic personalization. As students of Advanced Level, it is not generally an easy task .            </p>
          ...
          <figure class="hero-banner">
            ...
            <div class="img-holder two" style="--width: 240; --height: 370;">
              <img src="<?php echo URLROOT?>/assets/img/Landing/plan.png" width="240" height="370" alt="hero banner" class="img-cover">
            </div>

            <img src="" width="380" height="190" alt="" class="shape hero-shape-1">

            <img src="<?php echo URLROOT?>/assets/img/Landing/progress.png" width="622" height="551" alt="" class="shape hero-shape-2">
