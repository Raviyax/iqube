...
<section class="courses">
  ...
  <section class="form-container" style="display: block;">
      ...
      <section id="general" style="display: block;">
        <div class="flex">
          <div class="col">
            ...
            <input type="hidden" id="video_content_id" value="<?php echo $data['video']->id; ?>">
          </div>
    ...
    <div style="display: flex; flex-direction:row-reverse">
      <button class="btn" style="width: fit-content;" onclick="pay();">Confirm & Proceed
...
Not the correct method to verify payment. Notify url is not working in payhere
   ...
   payhere.onCompleted = function onCompleted() {
        ...
        formData.append('action', 'purchase_video');
        // Make a POST request using the fetch API
        fetch('<?= URLROOT ?>/api.php', {
            method: 'POST',
            body: formData,
